    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, System.getenv().get("database_url"));
                settings.put(Environment.USER, System.getenv().get("database_username"));
                settings.put(Environment.PASS, System.getenv().get("database_password"));
